...
//十一选五前二单式
exports.syxwQ2d=function(bet, kj){
	console.log(kj.substr(0, 5));
	return ds(bet, kj.substr(0, 5));
}

//十一选五后二单式
exports.syxwH2d=function(bet, kj){
	console.log(kj.substr(9, 5));
	return ds(bet, kj.substr(9, 5));
}

// 十一选五任选二单式
exports.syxwR2d=function(bet, kj, weiShu){
	console.log(getSSC_RKJ(weiShu));
	getSSC_RKJ(weiShu).split(',').map(function(v, i){
		if(v=='-') kj=kj.replaceList('-',i+1);
	});
	return ds(bet, kj);
...
//十一选五前三单式
exports.syxwQ3d=function(bet, kj){
	console.log(kj.substr(0, 8));
	return ds(bet, kj.substr(0, 8));
}

//十一选五中三单式
exports.syxwZ3d=function(bet, kj){
	console.log(kj.substr(3, 8));
	return ds(bet, kj.substr(3, 8));
}

//十一选五后三单式
exports.syxwH3d=function(bet, kj){
	console.log(kj.substr(6, 8));
	return ds(bet, kj.substr(0, 3));
}

// 十一选五任选三单式
exports.syxwR3d=function(bet, kj, weiShu){
	console.log(getSSC_RKJ(weiShu));
	getSSC_RKJ(weiShu).split(',').map(function(v, i){
		if(v=='-') kj=kj.replaceList('-',i+1);
	});
