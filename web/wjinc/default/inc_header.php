         <header class="header" style=" margin-bottom:38px;">
			  ...
			  <li><a class="users_info" href="<?=$this->basePath('Safe-info') ?>" ><div class="fa fa-bullhorn  fa-2x"></div>平台公告</a></li>
...
function down(){
    window.location="<?=$this->settings['templateurl'] ?>/template/down/新蜂娱乐.rar";
}
</script>