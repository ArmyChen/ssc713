...
<tr>
	<td>
		<ul id="content_1" class="news_list" style="display:block">
			...
			<ul>
				<p>
					<span style="color: rgb(255, 102, 0);"><strong>一、请认准新蜂娱乐唯一域名</strong></span>
				</p>
				<li>1、新蜂娱乐唯一的域名网址 <a href="" target="_blank">www.xfhaoge2012.net
				<li>
				<p>
				</p>
				</li>
			...
			<ul>
				...
				<li>
				<p>
					平台提现支持“支付宝”、“工商银行”、“农业银行”、“建设银行”，陆续会支持更多银行提现。
				</p>
				<p>
					提现限额：单笔最低提现100，最高提现1000000。
				</p>
				</li>
				<li>
				<p>
					服务时间：每日上午9:00至次日凌晨02:00。
				</p>
				</li>
				<li>
				<p>&nbsp;
		...
		<ul id="content_3" class="news_list" style="display:none">
			...
			<div style="width:600px;margin-left: 50px">
				...
				<div>
					<strong>第一步，</strong>单击截屏工具&nbsp;</a> 下载截图工具;
				</div>
				<div>
